...
public class FontsSkipLastModifiedCheckTestCase extends BaseConstructiveUserConfigTest {

    public FontsSkipLastModifiedCheckTestCase() throws SAXException, IOException {
        super(new FopConfBuilder().startRendererConfig(PDFRendererConfBuilder.class)
                                      .startFontsConfig()
                                          .addSkipLastModifiedCheck()
                                      .endFontConfig()
    ...
    public void testUserConfig() throws Exception {
        ...
        try {
            convertFO();
            PDFRendererConfig config = (PDFRendererConfig) fopFactory.getRendererConfig(null, null, mock);
            assertTrue(config.getFontInfoConfig().isSkipLastModifiedCheck());
        } catch (Exception e) {
